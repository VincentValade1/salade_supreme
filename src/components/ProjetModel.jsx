...
function ProjetModel({className, extraContent1, extraContent2, extraContent3, bannerImg, bannerImgM, altBannerImg, title, theme, description, img1, img1M, alt1, img2, img2M, alt2, img3, img3M, alt3}) {
    ...
    return (
        <section className={className}>
            {isMobile ? (
                <img tabIndex="0" className='projet-bannerImg' src={bannerImgM} alt={altBannerImg} />
            ) : (
